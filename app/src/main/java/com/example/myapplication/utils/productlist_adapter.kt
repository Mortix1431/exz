...
class productlist_adapter(private var ProductList : List<ProductList>, private val onClickListener: OnClickListener) : RecyclerView.Adapter<productlist_adapter.MyViewHolder>(){
